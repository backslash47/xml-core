...
export function executeTests() {
    context("GetXml/LoadXml/HasChanged", () => {
        ...
        it("Simple", () => {
            ...
            const xml = t.toString()
            assert.ok(xml.includes('id="123"'));
            assert.ok(xml.includes('xmlns="http://some.com"'));
            assert.ok(xml.includes('class="2"'));
        ...
        it("praser for attributes", () => {
            ...
            const t = new Test();
            let xml = t.toString();
            assert.ok(xml.includes('value="test"'));
            assert.ok(xml.includes('xmlns="https://some.com"'));
            ...
            assert.ok(xml.includes('value="test"'));
            assert.ok(xml.includes('xmlns="https://some.com"'));
            assert.ok(xml.includes('version="1"'));
