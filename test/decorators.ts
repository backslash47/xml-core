...
export function executeTests() {
    describe("Decorators", () => {
        ...
        context("Element", () => {
            ...
            context("GetXml", () => {
                ...
                it("namespace", () => {
                    ...
                    assert.ok(testStr.includes('id="test"'));
                    assert.ok(testStr.includes('xmlns="http://some.com"'));                
                    test.Id = "1";
                ...
                it("prefix with namespace", () => {
                    ...
                    const testStr = test.toString();
                    assert.ok(testStr.includes('id="test"'));
                    assert.ok(testStr.includes('xmlns:sm="http://some.com"'));                
                });

                it.skip("prefix without namespace", () => {
                ...
                context("Child", () => {
                    ...
                    class Child2 extends XmlBase {
                        @XmlChildElement({ localName: "text", namespaceURI: "http://number.com", defaultValue: new Uint8Array([1, 0, 1]), converter: XmlBase64Converter, required: true })
        ...
        it("extends", () => {
            ...
            assert.ok(firstStr.includes('Id="1"'));
            assert.ok(firstStr.includes('xmlns:p="http://some.com"'));
            ...
            assert.ok(secondStr.includes('Id="2"'));
            assert.ok(secondStr.includes('xmlns:p="http://some.com"'));
        ...
        context("XmlContent", () => {
            ...
            it("Required", () => {
                ...
                assert.ok(xml.includes('xmlns:p="http://some.com"'));                
                assert.ok(xml.includes('>test</p:test>'));                
